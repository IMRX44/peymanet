  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Risk severity scale (also exposed as CSS vars for animated fills)
        risk: {
      ...
      keyframes: {
        ...
        "risk-pulse": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(var(--risk-critical) / 0.45)" },
          "50%": { boxShadow: "0 0 0 6px hsl(var(--risk-critical) / 0)" },
        },
        shimmer: {
